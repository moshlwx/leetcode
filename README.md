...
### 适用场景
- 键值对存储，降低查找复杂度，适合循环中需要check if in set()等操作
- 计数排序
- 需要额外空间，适合对空间复杂度没有限制的问题
### 题目
- [剑指 Offer II 004. 只出现一次的数字](CODE/剑指%20Offer%20II%20004.%20只出现一次的数字%20.py)
  - 利用Counter在线性时间内统计数字出现次数
- [剑指 Offer II 006. 排序数组中两个数字之和](CODE/剑指%20Offer%20II%20006.%20排序数组中两个数字之和.py)
- [剑指 Offer II 007. 数组中和为 0 的三个数](CODE/剑指%20Offer%20II%20007.%20数组中和为%200%20的三个数.py)
  - [剑指 Offer II 006. 排序数组中两个数字之和](CODE/剑指%20Offer%20II%20006.%20排序数组中两个数字之和.py)的扩展，多一层排序和循环，需要注意重复元素的处理方法
...
- [剑指 Offer II 007. 数组中和为 0 的三个数](CODE/剑指%20Offer%20II%20007.%20数组中和为%200%20的三个数.py)
  - [剑指 Offer II 006. 排序数组中两个数字之和](CODE/剑指%20Offer%20II%20006.%20排序数组中两个数字之和.py)的扩展，多一层排序和循环，需要注意重复元素的处理方法
- [剑指 Offer II 018. 有效的回文](CODE/剑指%20Offer%20II%20018.%20有效的回文.py)
  - [剑指 Offer II 019. 最多删除一个字符得到回文](CODE/剑指%20Offer%20II%20019.%20最多删除一个字符得到回文.py) 一种变动，双指针遇到不同字符串时，尝试分左右跳过。
...
- 遍历
  - [剑指 Offer 13. 机器人的运动范围](CODE/剑指%20Offer%2013.%20机器人的运动范围.py)
  - [剑指 Offer 12. 矩阵中的路径](CODE/剑指%20Offer%2012.%20矩阵中的路径.py)
...
### 题目
- [3. 无重复字符的最长子串](CODE/3.%20无重复字符的最长子串.py) and [剑指 Offer 48. 最长不含重复字符的子字符串](CODE/剑指%20Offer%2048.%20最长不含重复字符的子字符串.py) and [剑指 Offer II 016. 不含重复字符的最长子字符串](CODE/剑指%20Offer%20II%20016.%20不含重复字符的最长子字符串.py)
- [76. 最小覆盖子串](CODE/76.%20最小覆盖子串.py) and [剑指 Offer II 017. 含有所有字符的最短字符串](CODE/剑指%20Offer%20II%20017.%20含有所有字符的最短字符串.py)
- [992. K 个不同整数的子数组](CODE/992.%20K%20个不同整数的子数组.py)
- [剑指 Offer 63. 股票的最大利润](CODE/剑指%20Offer%2063.%20股票的最大利润.py)
  - 滑动窗口解法，通过额外保存历史低位值，右指针计算当前与历史低位值的差异，是简化版的滑动窗口
- [剑指 Offer II 014. 字符串中的变位词](CODE/剑指%20Offer%20II%20014.%20字符串中的变位词.py)
- [剑指 Offer II 015. 字符串中的所有变位词](CODE/剑指%20Offer%20II%20015.%20字符串中的所有变位词.py)
...
### 题目
- [剑指 Offer II 008. 和大于等于 target 的最短子数组](CODE/剑指%20Offer%20II%20008.%20和大于等于%20target%20的最短子数组.py)
- [剑指 Offer II 009. 乘积小于 K 的子数组](CODE/剑指%20Offer%20II%20009.%20乘积小于%20K%20的子数组.py)
